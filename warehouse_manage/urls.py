...
urlpatterns = [
    ...
    path('report/task/force_stop/', report_views.force_stop_task_view, name='report_task_force_stop'),
    ...
    path('report/task/download-info/', report_views.download_report_info_view, name='report_task_download_info'),
